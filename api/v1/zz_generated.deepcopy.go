...
func (in *Storage) DeepCopyInto(out *Storage) {
	*out = *in
	...
	if in.BackupRequest != nil {
		in, out := &in.BackupRequest, &out.BackupRequest
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.BackupStorageClassName != nil {
		in, out := &in.BackupStorageClassName, &out.BackupStorageClassName
		*out = new(string)
		**out = **in
	}
}
