...
// 	writeString(&sb, "PublicDescription", strings.ReplaceAll(settings.Identity.PublicDescription, "\n", "\\n"))
...
// 	// Mods settings - prefer WorkshopMods over classic Mods format
...
// 	} else {
// 		writeString(&sb, "WorkshopItems", settings.Mods.WorkshopItems)
// 		writeString(&sb, "Mods", settings.Mods.Mods)
// 	}
...
// 	writeString(&sb, "ServerWelcomeMessage", strings.ReplaceAll(settings.Communication.ServerWelcomeMessage, "\n", "\\n"))
...
// 	case "PublicName":
// 		settings.Identity.PublicName = value
// 	case "PublicDescription":
// 		settings.Identity.PublicDescription = strings.ReplaceAll(value, "\\n", "\n")
// 	case "ResetID":
...
// 	// Mods settings
// 	case "WorkshopItems":
// 		settings.Mods.WorkshopItems = value
// 	case "Mods":
// 		settings.Mods.Mods = value
...
// 		settings.Logging.ClientCommandFilter = value
// 	case "ClientActionLogs":
// 		settings.Logging.ClientActionLogs = value
...
// 		settings.Steam.SteamScoreboard = value

// 	// Discord settings
// 	case "DiscordEnable":
// 		settings.Discord.DiscordEnable = parseBool(value)
// 	case "DiscordToken":
// 		settings.Discord.DiscordToken = value
// 	case "DiscordChannel":
// 		settings.Discord.DiscordChannel = value
// 	case "DiscordChannelID":
// 		settings.Discord.DiscordChannelID = value

// 	// Communication settings
// 	case "GlobalChat":
// 		settings.Communication.GlobalChat = parseBool(value)
// 	case "ChatStreams":
// 		settings.Communication.ChatStreams = value
// 	case "ServerWelcomeMessage":
// 		settings.Communication.ServerWelcomeMessage = strings.ReplaceAll(value, "\\n", "\n")
// 	case "VoiceEnable":
...
// 	case "SpawnPoint":
// 		settings.Gameplay.SpawnPoint = value
// 	case "SpawnItems":
// 		settings.Gameplay.SpawnItems = value
// 	case "NoFire":
